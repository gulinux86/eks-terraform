...
| <a name="input_log_retention_days"></a> [log\_retention\_days](#input\_log\_retention\_days) | Retention for the EKS control-plane log group. Unmanaged, EKS creates it with no expiry and audit logs accumulate forever. | `number` | `90` | no |
